...
def main(total):
    ...
    for each in total:
        font=ImageFont.truetype(choice(['./static/trebucbd.ttf','./static/comicbd.ttf','./static/comic.ttf','./static/VeraMoBI.ttf','./static/Times_New_Roman.ttf','./static/FreeSans.ttf','./static/Verdana_Italic.ttf']), randint(22,32))
